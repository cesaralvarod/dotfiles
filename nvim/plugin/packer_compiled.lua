...
_G.packer_plugins = {
  ...
  ["emmet-vim"] = {
    loaded = true,
    path = "/home/andres/.local/share/nvim/site/pack/packer/start/emmet-vim",
  ...
  ["lsp-colors.nvim"] = {
    loaded = true,
    path = "/home/andres/.local/share/nvim/site/pack/packer/start/lsp-colors.nvim",
  ...
  nerdcommenter = {
    loaded = true,
    path = "/home/andres/.local/share/nvim/site/pack/packer/start/nerdcommenter",
  ...
  ["trouble.nvim"] = {
    loaded = true,
    path = "/home/andres/.local/share/nvim/site/pack/packer/start/trouble.nvim",
    url = "https://github.com/folke/trouble.nvim"
  },
  ["vim-angular-snippets"] = {
    loaded = true,
    path = "/home/andres/.local/share/nvim/site/pack/packer/start/vim-angular-snippets",
    url = "https://github.com/tomoyukikashiro/vim-angular-snippets"
  },
  ["vim-closetag"] = {
    loaded = true,
  ...
  ["vim-javascript-snippets"] = {
    loaded = true,
    path = "/home/andres/.local/share/nvim/site/pack/packer/start/vim-javascript-snippets",
    url = "https://github.com/grvcoelho/vim-javascript-snippets"
  },
  ["vim-react-snippets"] = {
    loaded = true,
  ...
  ["vim-snippets"] = {
    loaded = true,
    path = "/home/andres/.local/share/nvim/site/pack/packer/start/vim-snippets",
