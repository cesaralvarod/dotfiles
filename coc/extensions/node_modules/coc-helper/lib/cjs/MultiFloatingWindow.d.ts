import { Disposable, Neovim } from 'coc.nvim';
import { Merge } from 'type-fest';
import { FloatingUtil } from './FloatingUtil';
import { FloatingWindow } from './FloatingWindow';
export declare namespace MultiFloatingWindow {
    type CreateOptions<WinKeys extends string = string> = Merge<FloatingWindow.CreateOptions, {
        wins: Record<WinKeys, FloatingWindow.CreateOptions>;
    }>;
    type OpenOptions<WinKeys extends string = string> = Merge<FloatingWindow.OpenOptions, {
        /**
