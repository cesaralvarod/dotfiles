...
class HelperLogger {
    constructor(channelName) {
        ...
        this.log = (levelName, data) => {
            ...
            if (data instanceof Error) {
                ...
                coc_nvim_1.window.showMessage(data.message, 'error');
            ...
            if (levelNum > levelErrorNum) {
                // eslint-disable-next-line no-restricted-properties
                coc_nvim_1.window.showMessage(data, 'error');
                if (env_1.isTest) {
                    // eslint-disable-next-line no-console
                    console.error(data);
                }
    ...
    prettyPrint(...data) {
        ...
        // eslint-disable-next-line no-restricted-properties
        coc_nvim_1.window.showMessage(`[${formatDate(new Date())}] ${prettyObject(...data)}`);
    }
}
