...
class HelperLogger {
    constructor(channelName) {
        ...
        this.log = (levelName, data) => {
            ...
            if (data instanceof Error) {
                ...
                void coc_nvim_1.window.showErrorMessage(data.message);
            ...
            if (levelNum > levelErrorNum) {
                void coc_nvim_1.window.showErrorMessage(data);
                if (env_1.isTest) {
                    // eslint-disable-next-line no-console
                    console.error(data);
                }
    ...
    prettyPrint(...data) {
        ...
        void coc_nvim_1.window.showErrorMessage(`[${formatDate(new Date())}] ${prettyObject(...data)}`);
    }
}
