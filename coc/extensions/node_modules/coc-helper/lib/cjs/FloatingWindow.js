...
class FloatingWindow {
    ...
    static getInitedExecute(mode, options) {
        ...
        initedExecute =
            FloatingWindow.modePresets[mode].createInitedExecute(FloatingWindow.initedContextVars.create) +
                '\n' +
                initedExecute;
    ...
    getInitedExecute(options) {
        ...
        initedExecute =
            FloatingWindow.modePresets[this.mode].openInitedExecute(FloatingWindow.initedContextVars.open) +
                '\n' +
                initedExecute;
...
FloatingWindow.srcId = coc_nvim_1.workspace.createNameSpace('coc-helper-floatwin');
