...
async function activateHelper(context, options = {}) {
    ...
    if ((_c = options.events) !== null && _c !== void 0 ? _c : true) {
        await events_1.helperVimEvents.register(context);
    }
    try {
        ...
        coc_nvim_1.window.showMessage(error.toString(), 'error');
    }
}
...
async function activate(context) {
    ...
    events_1.helperEvents.on('BufDelete', (bufnr) => {
        // eslint-disable-next-line no-restricted-properties
        coc_nvim_1.window.showMessage('buffer delete ' + bufnr);
    });
    ...
    await util_1.helperLogger.measureTask(async () => {
        ...
        coc_nvim_1.commands.registerCommand('testHelper-floating', async () => {
            const text = 'hello';
            await floatWin.open({
    ...
    await util_1.helperLogger.measureTask(async () => {
        ...
        coc_nvim_1.commands.registerCommand('testHelper-multi-floating', async () => {
            const width = 10;
